...
class OrderItemTest {
    ...
    void orderItem_ItemSize() {
        //given
        ItemCategory epl = ItemCategory.createItemCategory("EPL", null);
        ItemCategory manchesterUnited = ItemCategory.createItemCategory("Manchester United", epl);
        ...
        Item uniform = Item.createItem(manchesterUnited, "Adidas", "24-25 Home Replica", 150000, sizes);
